...
import io.designpatterns.builder.exception.InvalidAgeException;
import io.designpatterns.builder.exception.InvalidGradYearException;
import io.designpatterns.builder.exception.InvalidPhoneNumberException;
...
public class Student {
    ...
    public static class Builder {
        ...
        private void validate() throws InvalidAgeException {
            if(gradYear >= 2023)
